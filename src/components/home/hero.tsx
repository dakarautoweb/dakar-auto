          ...
          >
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <input
                ...
                className="w-full rounded-xl border border-border bg-surface px-4 py-3.5 font-mono uppercase tracking-widest text-foreground placeholder:font-sans placeholder:text-sm placeholder:normal-case placeholder:tracking-normal placeholder:text-muted-foreground focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/30 sm:flex-1"
              />
              <button
                type="submit"
                className="inline-flex items-center justify-center rounded-xl bg-accent px-6 py-3.5 text-sm font-semibold whitespace-nowrap text-accent-foreground shadow-sm transition hover:opacity-90"
              >
